...
<div class="wrapper row2">
    <div id="breadcrumb" class="clear">
        <ul style="margin-left: 15%">
            ...
            <li><a href="<?php echo base_url().'home'?>#Gallery">Home</a></li>
    ...
    <div class="gallery-grids-row">
        ...
        <div class="col-md-4 gallery-grid">
            <div class="wpf-demo-4">
                <a href="<?php echo base_url().'uploads/gallery/'.$image->folder.'/'.$image->imageName;?>" class="jzBoxLink item-hover" title="Events Venue">
                    <img src="<?php echo base_url().'uploads/gallery/'.$image->folder.'/'.$image->imageName;?>" alt=" " class="img-responsive" />
