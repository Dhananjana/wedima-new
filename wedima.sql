...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 01, 2018 at 02:21 PM
...
INSERT INTO `beautician` (`id`, `locationLat`, `locationLang`, `name`, `vision`, `description`, `telephone`, `address`, `serviceArea`) VALUES
...
INSERT INTO `entertainment` (`id`, `name`, `locationLat`, `locationLang`, `vision`, `description`, `telephone`, `address`, `serviceArea`) VALUES
(1, 'Darshana Perera', '6.8656182', '79.8706401', 'We cover the whole event depending on the crowd and the client’s requirement.', '“Flash Music Band” We do lot of weddings & other functions at five star hotels / Banquets / Reception halls in island wide. We cover the whole event light instrumental / Sinhala / English / Classical / 70s / Baila, all sorts of genres are covered depending on the crowd and the client’s requirement.', '719985000', 'Darshana Perera\r\nNugegoda,\r\nWestern Province', 'Colombo, Kaluthara');
