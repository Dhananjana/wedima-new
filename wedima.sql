...
--
-- Host: 127.0.0.1
-- Generation Time: May 18, 2018 at 10:25 AM
...
CREATE TABLE `album` (
  `id` int(11) NOT NULL,
  `album_name` varchar(5000) NOT NULL,
  `user_id` int(11) NOT NULL,
  `allvendorid` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `album` (`id`, `album_name`, `user_id`, `allvendorid`) VALUES
(4, 'Dinuka and Nayani', 1, 6),
(5, 'Tharka and Nimali', 1, 6),
(13, 'Wikrma and Nayanathara', 1, 6),
(19, 'tugj', 1, NULL),
(20, 'ex4r889', 1, NULL),
(21, 'estyter', 1, NULL),
(22, 'fdghjnkm', 1, NULL);
...
INSERT INTO `album_images` (`id`, `image_name`, `user_id`, `album_id`, `allvendorid`) VALUES
(4, 'th.jpg', 1, 4, NULL),
(5, 'waru.jpg', 1, 5, NULL),
(6, 's.jpg', 1, 4, NULL),
(12, '', 1, 12, NULL),
(13, 'i.jpg', 1, 13, NULL),
(14, '24131433_1894789610849824_7226490171589566491_n.jpg', 1, 14, NULL),
(15, '24129543_1894789547516497_4064580603328272967_n.jpg', 1, 15, NULL),
(16, '24059022_1894789760849809_7949348340837933890_n.jpg', 1, 16, NULL),
(17, '24059022_1894789760849809_7949348340837933890_n.jpg', 1, 17, NULL),
(18, '28471760_1945578252437626_6089890922584583169_n.jpg', 1, 18, NULL),
(19, '28279820_1945577742437677_750864573502750167_n.jpg', 1, 19, NULL),
(20, '28471760_1945578252437626_6089890922584583169_n.jpg', 1, 20, NULL),
(21, '28471760_1945578252437626_6089890922584583169_n.jpg', 1, 21, NULL),
(22, '2d22180a5e1131194f2a4d5f4d0c09f5.jpg', 1, 22, NULL);
...
INSERT INTO `bookmark` (`id`, `allvendorid`, `user_id`, `vendor_name`, `category`) VALUES
(12, 14, 2, 'Namal Balachandra', 'groomWear'),
(14, 9, 2, 'Ibride by INDI', 'bridalwear'),
(16, 6, 2, 'Duritha Bridal Dressing', 'bridalwear');
...
(1, '6.8271062', '79.9535615', 'Duritha Bridal Dressing', 'To become best service provider in the srilanka in the field', 'hhhh 182,Palanwatta,182,Palanwatta,Pannipitiya.', '0714720861', '182,Palanwatta,Pannipitiya.', 'Mathara', '2d22180a5e1131194f2a4d5f4d0c09f5.jpg', '26219926_1917621425233309_8505723246650878040_n1.jpg'),
...
INSERT INTO `cart` (`id`, `package_id`, `date`, `time`, `confremation`, `vendor_name`, `package_name`, `price`, `user_id`, `brought`) VALUES
(8, 6, '2018-05-31', '9.00-4.00', 'yes', 'Calla Bridal Dressing', 'Basic', '2500', 2, 'yes'),
(10, 15, '2018-06-03', '9.00-4.00', 'yes', 'Duritha Bridal Dressing', 'Premium', '4250', 2, 'yes'),
(11, 14, '2018-06-03', '9.00-4.00', 'yes', 'Duritha Bridal Dressing', 'Basic', '2500', 2, 'yes');
...
CREATE TABLE `cart1` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `initial_ammount` varchar(5000) DEFAULT '0',
  `current_total` varchar(50000) DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `cart1` (`id`, `user_id`, `initial_ammount`, `current_total`) VALUES
(7, 2, '0', '6750');
...
INSERT INTO `packages` (`id`, `allvendorid`, `description`, `title`, `price`) VALUES
(5, 7, 'ddfghjkl;/', 'Basic', '2500'),
(6, 7, 'ddfghjkl;/', 'Basic', '2500'),
(8, 7, 'ddfghjkl;/', 'Basic', '2500'),
(9, 7, 'ddfghjkl;/', 'Basic', '2500'),
(10, 7, 'ddfghjkl;/', 'Basic', '2500'),
(11, 7, 'ddfghjkl;/', 'Basic', '2500'),
(12, 7, 'ddfghjkl;/', 'Basic', '2500'),
(13, 7, 'ddfghjkl;/', 'Basic', '2500'),
(14, 6, 'aefedy rresterte5y65esy75e 5eserfc', 'Basic', '2500'),
(15, 6, 'UpperThreadingChin Thre', 'Premium', '4250');
