...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 19, 2018 at 06:54 AM
...
INSERT INTO `package1` (`id`, `packageName`, `description`, `price`, `packageImage`, `allvendorid`) VALUES
(1, 'basic', 'Upper Lip Threading\r\nHair Cut (any) + Wash\r\nConditioner Treatment+power dose', 12000, '', 6);
...
INSERT INTO `package2` (`id`, `packageName`, `description`, `price`, `packageImage`, `allvendorid`) VALUES
(1, 'standard', 'Normal Head Massage+ tonic\r\nRe-Bonding-Sholder Length\r\nClean up Jovees\r\nEye Treatment\r\nOil Treatment For Body', 20000, '', 6);
...
INSERT INTO `package3` (`id`, `packageName`, `description`, `price`, `packageImage`, `allvendorid`) VALUES
(1, 'Premium', 'Upper Lip Threading\r\nChin Threding\r\nHair Cut (any) + Wash\r\nConditioner Treatment+power dose\r\nHair Perm\r\nMake-up\r\nMenicure\r\nHair Straightning', 35000, '', 6);
